...
export default function ActionButtons() {
  ...
  // 방법 3가지
  // className={cx(style.commentButton, commented && style.commented)}
  // className={cx(style.repostButton, reposted && style.reposted)}
  // className={cx(args:[style.heartButton, liked && style.liked])}
